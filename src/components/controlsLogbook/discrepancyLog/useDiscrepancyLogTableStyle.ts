...
export const useDiscrepancyLogTableStyle = () => {
    ...
    return {
      perpetualInventoryTableContainer: css`
        ...
        .ant-table-cell {
          ...
          :nth-child(5) {
            min-width: ${pxToRem(71)} !important;
          }
          ...
          :nth-child(7) {
            min-width: ${pxToRem(151)} !important;
          }
          ...
          :last-child {
            ...
            max-width: ${pxToRem(58)} !important;
          }
        ...
        tbody {
          .ant-table-cell svg {
            font-size: ${pxToRem(13.5)} !important;
          }
        }
      `,
